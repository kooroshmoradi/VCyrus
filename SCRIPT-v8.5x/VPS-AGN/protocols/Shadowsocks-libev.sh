...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/kooroshmoradi/VCyrus/master/LINKS-LIBRARIES/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
