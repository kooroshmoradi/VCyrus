...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-R.sh https://raw.githubusercontent.com/kooroshmoradi/VCyrus/master/LINKS-LIBRARIES/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
